...
public interface BankAccountRepo extends JpaRepository<BankAccount,String>{
	  ...
	  @Query("SELECT b FROM BankAccount b WHERE LOWER(b.accountNumber) = LOWER(:accountNumber)")
	    BankAccount findByAccountNumberIgnoreCase(@Param("accountNumber") String accountNumber);
//    @Modifying
